...
class LossyStateStreamSynchronizer$1 {
   ...
   static {
      try {
         $SwitchMap$com$jagex$game$runetek6$comms$statestream$SyncPacket$SectionType[SyncPacket$SectionType.DELTA.ordinal()] = 1;
      } catch (NoSuchFieldError var4) {
      }

      try {
         $SwitchMap$com$jagex$game$runetek6$comms$statestream$SyncPacket$SectionType[SyncPacket$SectionType.PACKET_ACKNOWLEDGE.ordinal()] = 2;
