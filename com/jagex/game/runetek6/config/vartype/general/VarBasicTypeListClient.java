...
public class VarBasicTypeListClient extends VarTypeList {
   ...
   public VarBasicType list(int var1) {
      Eq28 var3 = this.recentUse;
      synchronized(var3) {
         VarBasicType var2 = (VarBasicType)this.recentUse.g((long)var1);
         if (var2 == null) {
            byte[] var4 = this.configClient.getfile(super.variableDomain.getJs5GroupID().id, var1);
            var2 = new VarBasicType(super.variableDomain, var1);
            if (var4 != null) {
   ...
   public VarBasicTypeListClient(Gd27 var1, VarDomainType var2, Language var3, js5 var4) {
